...
<Figure index={1} title="No Stop Propagation" >
...
<Figure index={1} title="Vanilla Click Only" >
  <EventPlayground label={'#1'} reset reactStopCapture>
    <EventPlayground label={'#2'} >
      <EventPlayground label={'#3'} />
    </EventPlayground>
  </EventPlayground>
...
<Figure index={1} title="React Click Only" >
  <EventPlayground label={'#1'} reset vanillaStopCapture>
    <EventPlayground label={'#2'} >
      <EventPlayground label={'#3'} />
    </EventPlayground>
  </EventPlayground>
